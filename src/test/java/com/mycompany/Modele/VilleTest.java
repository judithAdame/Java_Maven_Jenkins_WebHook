...
public class VilleTest {
    ...
    /**
     * Test of formatID method, of class Ville.
     */
    @Test
    public void testFormatID() {
        ...
        String expResult = "QCX2019";
        String result = instance.formatID(ville);
        assertEquals(expResult, result);
    }

    /**
     * Test of toString method, of class Ville.
     */
    @Test
    public void testToString() {
        ...
        String expResult = "Ville{nomVille=Montreal, province=Quebec, equpes=}";
